...
public class Induction {
    ...
    private String cstomerQuotation;
    ...
    public void setTechnologyModule(String technologyModule) {
    ...
    public String getInductionPlace() {
        return inductionPlace;
    }

    public void setInductionPlace(String inductionPlace) {
        this.inductionPlace = inductionPlace;
    }
    ...
    public String getCstomerQuotation() {
        return cstomerQuotation;
    }

    public void setCstomerQuotation(String cstomerQuotation) {
        this.cstomerQuotation = cstomerQuotation;
    }
